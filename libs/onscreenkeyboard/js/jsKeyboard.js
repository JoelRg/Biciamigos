var jsKeyboard = {
    ...
    defaultKeyboard: {
        ...
        // 2nd row
                ...
                { value: "&Ntilde;", isChar: "false", onclick: "jsKeyboard.writeSpecial('&Ntilde;');" },
        // 3rd row
        ...
        // 4th row
                ...
                { value: 44 }, // ","
                { value: "⌞&nbsp⌟", isChar: "false", buttonClass: "button button_space", onclick: "jsKeyboard.space();", keyClass: "key key_space" },
                { value: 46 }, // "."
                { value: 64 }, // "@"
        ...
        // 2nd row
                ...
                { value: 45},{ value: 47 },{ value: 44 },{ value: 46 },{ value: 58 },{ value: 59 },
                { value: 40 },{ value: 41 },{ value: 36 },{ value: 38 },
        //3rd row
                //{ value: "", isChar: "false", buttonClass: "button button_capitalletterleft", onclick: "", keyClass: "key" },
                { value: "abc", isChar: "false", buttonClass: "button button_smallletter_text", onclick: "jsKeyboard.changeToSmallLetter()", keyClass: "key key_smallletter_text" },
                //{ value: 63},{ value: 33 },{ value: 34 },{ value: 124 },
                { value: 33 },{ value: 34 },{ value: 124 },
                { value: 92 },{ value: 42 },{ value: 61 },{ value: 43 },
        ...
        // 4th row
                ...
                //{ value: "123", isChar: "false", buttonClass: "button button_numberleft", onclick: "jsKeyboard.changeToNumber();", keyClass: "key key_number" },
                { value: "?=<", isChar: "false", buttonClass: "button button_symbolsleft", onclick: "jsKeyboard.changeToSymbols();", keyClass: "key key_symbols" },
                { value: "⌞&nbsp⌟", isChar: "false", buttonClass: "button button_space_large", onclick: "jsKeyboard.space();", keyClass: "key key_space" },
                { value: "Enter", isChar: "false", buttonClass: "button button_enter", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
            ],
        symbols: [
        // 1st row
        ...
        // 2nd row
            ...
            { value: 163 },{ value: 165 },{ value: 92 },
        // 3rd row
            // { value: "ABC", isChar: "false", buttonClass: "button button_capitalletterleft", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterleft" },
            //{ value: "", isChar: "false", buttonClass: "button button_capitalletterleft", onclick: "", keyClass: "key" },
            { value: "abc", isChar: "false", buttonClass: "button button_smallletter_text", onclick: "jsKeyboard.changeToSmallLetter()", keyClass: "key key_smallletter_text" },
            { value: 46 },{ value: 44 },{ value: 63 },{ value: 33 },{ value: 39 },{ value: 34 },{ value: 59 },
            // { value: "ABC", isChar: "false", buttonClass: "button button_capitalletterright", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterright" },
            { value: "Delete", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "button button_del", keyClass: "key key_del" },
        // 4th row
            { value: "123", isChar: "false", buttonClass: "button button_numberleft", onclick: "jsKeyboard.changeToNumber();", keyClass: "key key_number" },
